...
const calculateBmi = (e) => {
    ...
    if (calculateCm.value === "" || calculateKg.value === "") {
        ...
        if (bmi < 18.5) {
            ...
            calculateMessage.classList.add("color-gray");
            calculateMessage.textContent = `Your BMI is ${bmi} and you are skinny`;
        } else if (bmi < 25) {
            calculateMessage.classList.add("color-green");
            calculateMessage.textContent = `Your BMI is ${bmi} and you are healthy`;
        } else if (bmi < 30) {
            calculateMessage.classList.add("color-overw");
            calculateMessage.textContent = `Your BMI is ${bmi} and you are overweight`;
        } else if (bmi < 40) {
            calculateMessage.classList.add("color-obese");
            calculateMessage.textContent = `Your BMI is ${bmi} and you are obese`;
        } else {
            calculateMessage.classList.add("color-red-bl");
...
const sendEmail = (e) => {
    ...
    if (contactUser.value === "") {
        ...
        contactMessage.classList.add("color-red-bl");
